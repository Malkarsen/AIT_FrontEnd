...
// - shift() - метод массива, который добавляет элемент в начало массива
fruits.shift("Pear");
console.log(fruits);
// - unshift() - удаляет элемент с начала массива(а ещё и возвращает в переменную удаленный элемент)
let pear = fruits.unshift();
